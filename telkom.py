...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	print(f'''\t{asu}   ______________________________________✡
\t ______________ mm   m   mm    mmmm    mm 
\t______________  #"m  #   ##   #"   "   ##
\t______________  # #m #  #  #  "#mmm   #  #
\t ______________ #  # #  #mm#      "#  #mm#
\t  ______________#   ## #    # "mmm#" #    #
       {m}•{k}•{h}•{sir} Sattelit.ID {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t✏ Recode : [blue]NASA[green] ⚔'))
...
def menu(my_name,my_id):
	...
	cetak(nel('\tSelamat Datang [blue]%s[white] Maling'%(my_name)))
	print(f'>> ʸᵒᵘʳ ᴵᴰ  : '+str(my_id))
	print(f'>> ʸᵒᵘʳ ᴵᴾ  : {ip}')
	print('')
...
def setting():
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] ᴍᴀsᴜᴋᴀɴ ᴘᴀssᴡᴏʀᴅ ᴍɪɴɪᴍᴀʟ 𝟼 ᴋᴀʀᴀᴋᴛᴇʀ\n[[cyan]•[white]] ᴄᴏɴᴛᴏʜ :[green] ᴋᴏɴᴛᴏʟ,ʙᴀᴘᴀᴋᴋᴀᴜ,ᴘᴇᴛᴊᴀʜ[white] '))
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'{m}>>>>> {k}>>>>> {h}>>>>> {b}>>>>> {m}•{k}•{h}•{x} C̶R̶A̶C̶K̶I̶N̶G̶ {m}•{k}•{h}•{x} {b}<<<<< {h}<<<<< {k}<<<<< {m}<<<<< ')
	print('')
	print(f'{k}>> 𝚁𝙴𝚂𝚄𝙻𝚃 {h}OK{x} 𝚜𝚊𝚟𝚎 𝚒𝚗 : {h}OK/%s {x}'%(okc))
	print(f'{k}>> 𝚁𝙴𝚂𝚄𝙻𝚃 {b}CP{x} 𝚜𝚊𝚟𝚎 𝚒𝚗 : {b}CP/%s {x}'%(cpc))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r🗿 {P}[{b}{loop}{P}/{h}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{b}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
	sys.stdout.flush()
	ua =random.choice(["Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-A217M) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/19.0 Chrome/102.0.5005.125 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 9; CPH2015) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; CPH2113) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; CPH2185) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5 Plus) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 11; RMX3231 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.54 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 11; CPH2269) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; CPH2197) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; CPH2179) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 11; RMX3231) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 6.0.1; SM-G532G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.157 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; Infinix X680B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 8.1.0; Redmi 6A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 8.1.0; CPH1909) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36"])
